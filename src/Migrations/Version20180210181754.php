...
class Version20180210181754 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE reaction (id INT AUTO_INCREMENT NOT NULL, company_id INT DEFAULT NULL, rezume_id INT DEFAULT NULL, send_time DATETIME NOT NULL, reaction DATETIME NOT NULL, INDEX A4D707F7979B1AD6 (company_id), INDEX A4D707F747FAEADA (rezume_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rezume (id INT AUTO_INCREMENT NOT NULL, position VARCHAR(255) NOT NULL, file VARCHAR(255) NOT NULL, text LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX 1DC99F2A462CE4F5 (position), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
